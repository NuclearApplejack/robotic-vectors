...
public class HighJumpRobot : GeneralRobot
{
    ...
    new void Start()
    {
        ...
        taskList.Add(new JumpTask(1.3f, true, gameObject, 1500f * transform.localScale.y));
        taskList.Add(new WaitTask(1f, gameObject));
        taskList.Add(new PatrolTask(rightDuration, false, gameObject));
        taskList.Add(new JumpTask(1.3f, false, gameObject, 1500f * transform.localScale.y));
