...
public class HighJumpRobot2 : GeneralRobot
{
    ...
    new void Start()
    {
        ...
        taskList.Add(new JumpTask(1.5f, true, gameObject, 1700f * transform.localScale.y));
        taskList.Add(new WaitTask(1f, gameObject));
        taskList.Add(new JumpTask(1.5f, false, gameObject, 1700f * transform.localScale.y));
